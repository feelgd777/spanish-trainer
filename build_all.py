...
def call_openai(corpus: str) -> str:
    system_msg = (
        ...
        "\n"
        "1) vocab  (word-level vocabulary including articles)\n"
        "   - JSON array under key 'vocab'\n"
        "   - Each item: {\"es\": <spanish word or short phrase with article>, "
        "\"en\": <english>, \"ru\": <russian>}\n"
        "   - Only include items where you are reasonably confident about.\n"
        ...
        "   - You MUST produce AT LEAST 50 items if the corpus is long enough.\n"
        "   - Each item:\n"
        "       {\n"
        ...
        "   vuestro/a/os/as, mio/a/os/as, tuyo/a, suyo/a,)\n"
        ...
        "         \"translation_en\": \"My freinds like to play with their pets.\",\n"
        ...
        "   - Try to cover:\n"
        "       - me/te/le/nos/les before verbs (gustar-type, parece or regular verbs),\n"
        ...
        "   - Use verbs similar to: despertarse, levantarse, ducharse, lavarse, ponerse, "
        ...
        "         \"translation_en\": \"After I wake up I usually take a shower.\",\n"
        ...
        "     gustar-type verbs, parece, simple prepositions, questions, conjucations, comparatives and the vocab fields given.\n"
